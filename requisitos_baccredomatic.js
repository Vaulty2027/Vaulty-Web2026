...
// ============================================
// HEADER — altura dinámica + efecto scroll
// ============================================
...
function actualizarAlturaHeader() {
    ...
    document.documentElement.style.setProperty('--vaulty-header-height', `${altura}px`);
}
...
function setActiveNavLink() {
    ...
    const paginasDePrestamos = ['finanzas_prestamos.html', 'requisitos_baccredomatic.html'];
...
// ============================================
// ANIMACIONES DE ENTRADA (reveal propio de esta sección)
// ============================================

function iniciarAnimacionesBACCredomatic() {
    const section = document.querySelector('.baccredomatic-section');
...
function iniciarMicrointeraccionesBACCredomatic() {
    const cards = document.querySelectorAll('.benefit-card, .requirement-card, .rates-card');
...
function iniciarAsistente() {
    ...
    if (!strixBtn || !cerrarChatBtn || !asistente || !mensajesDiv) return;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    iniciarAnimacionesBACCredomatic();
    iniciarMicrointeraccionesBACCredomatic();
