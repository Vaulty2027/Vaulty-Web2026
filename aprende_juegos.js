...
(() => {
    const grupos = document.querySelectorAll(
        '.cards-grid, .features-grid, .entidades-lista, .cards-container, .hero-features, .juegos-cards'
    );
...
(() => {
    ...
    document.querySelectorAll('a, button, .juegos-card, #strix-btn').forEach(element => {
