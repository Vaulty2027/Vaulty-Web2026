...
function setActiveNavLink() {
    ...
    const paginasDePrestamos = ['finanzas_prestamos.html', 'requisitos_globalbank.html', 'requisitos_cajadeahorros.html', 'requisitos_banistmo.html'];
...
// ============================================
// ANIMACIONES BANISTMO (reveal al hacer scroll)
// ============================================

function iniciarAnimacionesBanistmo() {
    const section = document.querySelector('.banistmo-section');
...
function iniciarBotonRegresar() {
    ...
    backButton.addEventListener('click', () => {
        window.dispatchEvent(new CustomEvent('banistmo:back'));
