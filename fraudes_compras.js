...
(() => {
    const grupos = document.querySelectorAll('.cards-grid, .features-grid, .entidades-lista, .cards-container, .hero-features, .recaudacion-grid, .planning-grid, .cards-compras');
...
(() => {
    ...
    document.querySelectorAll('a, button, .entidad-card, .card, .recaudacion-card, .planning-card, .info-card, #strix-btn').forEach(element => {
