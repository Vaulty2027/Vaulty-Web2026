...
function setActiveNavLink() {
    ...
    const paginasDePrestamos = ['finanzas_prestamos.html', 'requisitos_globalbank.html', 'requisitos_cajadeahorros.html'];
...
// ============================================
// ANIMACIONES CAJA DE AHORROS (reveal al hacer scroll)
// ============================================

function iniciarAnimacionesCajaDeAhorros() {
    const section = document.querySelector('.cajadeahorros-section');
...
// ============================================
// MICROINTERACCIONES — tarjetas y contador de tasas
// ============================================

function iniciarMicrointeraccionesCajaDeAhorros() {
    ...
    const targets = [...rateNumbers].map(number =>
        Number.parseFloat(number.dataset.value) || 0
    );
...
function iniciarBotonRegresar() {
    ...
    backButton.addEventListener('click', () => {
        window.dispatchEvent(new CustomEvent('cajadeahorros:back'));
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    iniciarAnimacionesCajaDeAhorros();
    iniciarMicrointeraccionesCajaDeAhorros();
