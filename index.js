...
function setLang(lang) {
    ...
    // ----------------------------------------
    // ACTUALIZAR STRIX Y FRASE ROTATIVA
    // ----------------------------------------
...
(() => {
    const grupos = document.querySelectorAll('.cards-grid, .features-grid, .entidades-lista, .cards-container, .hero-features');
...
(() => {
    ...
    document.querySelectorAll('a, button, .entidad-card, #strix-btn').forEach(element => {
...
// ============================================
// FRASE ROTATIVA DEL HERO (texto dinámico)
// ============================================
...
function reiniciarTagline() {
    ...
    taglineTimer = setInterval(() => {
        ...
        setTimeout(() => {
            ...
            contenedor.classList.remove('leaving');
            // fuerza el reinicio de la animación de entrada
